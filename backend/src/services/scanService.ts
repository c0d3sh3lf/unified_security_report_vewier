...
import { parseReport, type Finding } from './reportParser.js';
...
const summarize = (findings: Finding[]) => findings.reduce((summary, finding) => { summary[finding.severity as keyof typeof summary] += 1; summary.total += 1; return summary; }, { critical: 0, high: 0, medium: 0, low: 0, info: 0, unknown: 0, total: 0 });
